            ...
            <tr>
                 <form action="Menu" >
                    ...
                    <c:forEach var="productos" items="${listadoProductos}" >
						...
						<td>${productos.editorial}</td>
						<td>${productos.descripcion}</td>
						<td>${productos.fecha}</td>
						<td>${productos.categoria}</td>
						<td>Foto</td>
						<td><button type="submit" class="btn btn-primary" name="opcion" value="editarComic" >Editar</button>
            			<button type="submit" class="btn btn-danger" name="opcion" value="eliminarComic">Eliminar</button> 
            			<input type=hidden name="id" value="${productos.id}" ></td>
            			</tr>
					</c:forEach>
